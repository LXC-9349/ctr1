...
public class FileUtil {
     ...
     */
    public static void generateToJava(int type, Object data, String filePath_fileName,String filePath) throws IOException, TemplateException {
        File file = new File(filePath_fileName);
        if (file.exists()) {
        	file.delete();
        }
        ...
        writer.flush();
        // 写入文件
        FileOutputStream fos = new FileOutputStream(filePath_fileName);
